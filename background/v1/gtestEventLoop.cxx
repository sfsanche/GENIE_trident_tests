...
int main(int argc, char ** argv)
{
  ...
  int nev = (gOptNEvt > 0) ?
	...
	//...............File management................
	TFile results_file("dimuons_NuMI_C12.root","recreate");
	ofstream Nu_report;
	Nu_report.open("dimuons_NuMI_C12.txt");
...
//.............Now begins the analysis............	
	...
	//................Event Selection Cuts................
    	...
    	TIter event_iter(&event);
			...
			{   
				...
				if (p->Status() != 1) continue;	//Analize only final state particles
		...
		// end loop over particles	
				if (cleptons >=2) 
				{
					LOG("myAnalysis", pNOTICE) "Event: "<< i << " shreds!\n";
					//LOG("myAnalysis", pNOTICE) "Event" << event ;
				}
		
				else continue; //Skip events that have less than two leptons
  ...
  file.Close();
	...
	for(int k=1;k<=bincut;k++) histo_part_cut->Fill(ax->GetBinLabel(k),histo_part->GetBinContent(k));
	...
	for(int k=1;k<=bincut_rx;k++) histo_rx_cut->Fill(ax_rx->GetBinLabel(k),histo_rx->GetBinContent(k));
